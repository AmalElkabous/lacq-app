...
<form method="post" id="modalModal" action="{{ url('/matrices') }}"  enctype="multipart/form-data">
    <div class="modal fade bd-example-modal-lg" id="modalEditMatrice" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                @if(Auth::user()->role_id <= 2)
                                    <td class="text-right">
                                        <div class="d-inline p-2">
                                            <button class="btn btn-primary btn-sm btnAction" onclick="openEditMatriceModal({{ $matrice->id }})"><i class="fa fa-edit"></i></button>
                                        </div>
