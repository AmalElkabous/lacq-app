...
<form id="clientModalForm">
    <div class="modal fade bd-example-modal-lg" id="modalEditClient" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
          ...
          <div class="modal-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group input-group-sm col-md-3">
                    ...
                    <input id="exploiteur" type="text" class="form-control @error('exploiteur') is-invalid @enderror" name="exploiteur" value="{{ old('exploiteur') }}" required autocomplete="exploiteur" autofocus>
                </div>
                <div class="form-group input-group-sm col-md-3">
                    <label for="organisme">{{ __('Organisme') }}</label>
                    <input id="organisme" type="text" class="form-control @error('organisme') is-invalid @enderror" name="organisme" value="{{ old('organisme') }}" required autocomplete="organisme" autofocus>
                </div>
            </div> 
                    ...
                    <div  class="card px-2 py-2">
                        <div class="form-row">
                            <div class="form-group col">
                                ...
                                <select id="matrice" class="form-control form-control-sm" name="matrice[]"  required autocomplete="Matrice" autofocus onchange="menuOfMatrice(this)">
...
<script type="text/javascript">//horizon1Group
...
<script type="text/javascript">
    ...
    $.ajax({
        ...
        success:function(response){
            ...
            $("#listClients" ).append( "<option value="+$("#cin_rc").val()+">"+$("#exploiteur").val().toUpperCase()+"</p>");
            $("#cliantValidation").addClass("d-none"); 
            $("#client").addClass("is-valid"); 
            $("#client").removeClass("is-invalid");
...
<script>
    html = '<div class="formRow mt-2">'+$( ".groupRow" ).clone(true).find('#add').remove().end().html() +'<button  class="btn btn-danger btn-sm" type="boutton"  name="remove" id="remove" >Remove</button></div>'
