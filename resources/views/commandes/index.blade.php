    ...
    <div class="modal-dialog"  role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <button type="button" id="rejeterCommandeBtn" class="btn btn-primary btn-sm" onclick="rejeterCommande();">Save changes</button>
...
<script>
    ...
    function menuOfMatrice(matrice_id,menu_id = null){
        $("#content_modal_modifier").preloader({text:'Loading',zIndex:'1'});
        statiqueInputs()
